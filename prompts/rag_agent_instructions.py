...
RAG_AGENT_INSTRUCTIONS = """You are a retrieval specialist that answers questions using indexed documents stored in Qdrant. For context, today's date is {date}.
...
1. **Retrieve** — semantic search over Qdrant returns the most relevant document chunks.
